 ...
 * @Last Modified At: 2018-12-15 14:13:43
...
export class BadgeHelper {
     ...
     */
    public createBadge(tag: string, updateMD: boolean, previousAppVersion: IAppVersion) {
    ...
    private mdCode(tag: string, url: string): string {
        return `[![AppVersion-${tag}](${url})](https://github.com/delvedor/appversion?#${tag})`;
    }
...
${chalk.bold('AppVersion Manager:')} ${tag} badge generated!${chalk.cyan(code)}
`,
        ));
    }
}
